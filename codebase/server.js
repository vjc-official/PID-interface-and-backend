...
client.on("message", (topic, message) => {
  try {
    ...
    console.log(
      `Rise Time: ${data.riseTime}, Settling Time: ${data.settlingTime}, Steady State Error: ${data.steadyStateError}, Overshoot: ${data.overshoot}, Setpoint: ${data.setpoint}, Actual Value: ${data.actualValue}`,
    );
  } catch (error) {
